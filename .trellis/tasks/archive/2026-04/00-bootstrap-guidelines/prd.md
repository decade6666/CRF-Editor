...
- `directory-structure.md` - Layered architecture (routers → services → repositories → models)
- `database-guidelines.md` - SQLite WAL, SQLAlchemy 2.x, lightweight migrations
- `error-handling.md` - HTTPException with Chinese detail, Pydantic validation
- `logging-guidelines.md` - Python logging, log levels, what to log/not log
- `quality-guidelines.md` - pytest 80%+ coverage, forbidden patterns

### Frontend Guidelines (6 files)
- `directory-structure.md` - Vue 3 SFC organization, composables, tests
- `component-guidelines.md` - script setup, Element Plus, scoped CSS
- `hook-guidelines.md` - useApi for all API calls, naming conventions
- `state-management.md` - ref/reactive, provide/inject, localStorage
- `type-safety.md` - JSDoc annotations, contract testing with fast-check
- `quality-guidelines.md` - node:test, property-based testing, Element Plus
