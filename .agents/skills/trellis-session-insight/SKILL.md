...
description: "通过 `trellis mem` CLI 检索过往 AI 会话历史。适用于用户询问“上次怎么解的”“之前讨论过吗”“当时怎么决定的”“这个任务做了什么”，或开始与既往工作重叠的头脑风暴、调试熟悉缺陷、跨会话续作、完成收尾评审时。返回原始历史对话；再根据当前场景决定是否更新规格、追加任务备注、引用到回答中或仅内部吸收。"
---
