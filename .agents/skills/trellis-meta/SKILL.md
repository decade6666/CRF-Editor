---
name: trellis-meta
description: "理解并定制用户项目内的本地 Trellis 架构。适用于修改 .trellis、平台 hooks、settings、agents、skills、commands、prompts、workflows、频道运行时、内置运行 Agent、可选工作流模板、规格刷新、跨会话记忆，或 AI 面向的内置技能与自动派发流程。"
---
