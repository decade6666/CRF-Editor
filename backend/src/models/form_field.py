...
class FormField(Base):
    ...
    # 标签是否加粗（1=加粗，0=不加粗；NULL 视为加粗以兼容旧数据）
    label_bold: Mapped[int] = mapped_column(Integer, nullable=False, default=1, server_default="1")

    # 标签字号档位（large/default/small；NULL 视为 default）
